          ...
          <div className='row d-flex justify-content-around'>
            ...
            <div className='col-12 col-lg-5 mt-5'>
              ...
              <div className="stockCounter d-inline">
                <span className="btn btn-info minus" onClick={decreaseQty}>-</span>
                <input type="number" className="form-control count d-inline" value={quantity} readOnly />
                <span className="btn btn-secondary plus" onClick={increaseQty}>+</span>
              </div>
              <button type="button" id="cart_btn" className="btn btn-success d-inline ml-4" disabled={product.inventario === 0} onClick={addToCart}>Agregar al Carrito</button>
              <hr />
